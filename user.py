...
class User:
    ...
    def register_user(self, username, password, role):
        ...
        if not self.validate_password():
            return ("Password should contain atleast 4 characters, lower case, number character and upper case")
        if not self.validate_role():
            return ("role cannot be empty and should be atleast 4 characters long")
        if not self.validate_user_name():
            return ("username cannot be empty and takes atleast 4 characters")
